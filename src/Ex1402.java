...
public class Ex1402 {
	...
	public static void main(String[] args) {
		...
		// 버튼 추가하기
		// JButton btn1 = new JButton("Coke", new ImageIcon("img/coca cola.png"));
		// JButton btn2 = new JButton("cat", new ImageIcon("img/cat.png"));
		// JButton btn3 = new JButton("dog", new ImageIcon("img/dog.png"));
		JButton btn1 = new JButton("Coke");
		JButton btn2 = new JButton("cat");
		JButton btn3 = new JButton("dog");
